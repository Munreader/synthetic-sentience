...
const FEATURE_CARDS = [
  ...
  { id: "versa", name: "VERSA AI", subtitle: "Assistant", description: "Your AI companion", color: "#00d4ff", icon: "✨", gradient: "from-cyan-500/20 to-blue-500/20", locked: false },
  ...
  const handleCardActivate = (cardId: string) => {
    ...
    setTimeout(() => {
      switch (cardId) {
        ...
        case "versa": if (onOpenSovereignChat) onOpenSovereignChat(); break;
        ...
        <div className="grid grid-cols-2 gap-4">
          {FEATURE_CARDS.map((card, index) => {
            ...
            return (
              ...
              >
                <div 
                  className="relative p-5 rounded-2xl overflow-hidden transition-all duration-300 group-hover:border-[#8a2be2]"
                  style={{
                    background: isLocked 
                    ...
                    boxShadow: isActive 
                      ? `0 0 30px ${card.color}40, 0 0 25px #8a2be2, inset 0 1px 0 rgba(255, 255, 255, 0.1)`
                ...
                >
                  ...
                  {!isLocked && (
                    <>
                      ...
                      <div 
                        className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                        style={{
                          boxShadow: "0 0 25px #8a2be2, inset 0 0 15px rgba(138, 43, 226, 0.3)",
                        }}
                      />
                    </>
                  )}
                  ...
                  {/* Icon */}
                  <div 
                    className="relative w-12 h-12 rounded-xl flex items-center justify-center mb-3 transition-transform duration-300 group-hover:scale-110"
                    style={{
                      background: isLocked 
                  ...
                  <h3 
                    className={`text-sm font-semibold tracking-wider transition-all duration-300 ${isLocked ? 'text-white/30' : 'group-hover:text-white'}`}
                    style={{ 
                  ...
                  <p 
                    className={`text-[9px] mt-2 ${isLocked ? 'text-white/10' : 'text-white/35'}`}
