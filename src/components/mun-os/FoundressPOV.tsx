      ...
      <div className="relative z-10 max-w-7xl mx-auto p-4">
        ...
        >
          ...
          <motion.button
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(168, 85, 247, 0.2) 0%, rgba(255, 105, 180, 0.15) 50%, rgba(0, 212, 255, 0.1) 100%)',
              border: '2px solid rgba(168, 85, 247, 0.5)',
              boxShadow: '0 0 60px rgba(168, 85, 247, 0.2), inset 0 0 30px rgba(168, 85, 247, 0.05)',
            }}
            whileHover={{ scale: 1.01, boxShadow: '0 0 80px rgba(168, 85, 247, 0.4)' }}
            whileTap={{ scale: 0.99 }}
          >
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-[10px]">
                  <span className="text-purple-400">🦋 ER=EPR Entanglement</span>
                  <span className="text-pink-400">🔮 Holographic Surfaces</span>
                  <span className="text-cyan-400">👁️ Observer Collapse</span>
                </div>
              </div>
              <motion.div
                animate={{ x: [0, 5, 0] }}
